...
public class AlkalineEarthMetals extends Element {
	...
	public AlkalineEarthMetals () {
		super();
	}

	//Constructor with all data fields 
	public AlkalineEarthMetals(double atomicWeight, double meltingPoint, double boilingPoint, double density) {
		super();
	...
	//Constructor  with all properties
		public AlkalineEarthMetals (int atomicNumber, String name, String symbol, String electron, String origin, int group,
	...
	public String properties() {
		...
		return "Properties : Shiny and silvery-white. Somewhat reactive metals at standard temperature and pressure. "
				+ "Readily lose their two outermost electrons to form cations with a 2+ charge.\r\n" + 
				"low densities. Low melting and Boiling points";
	}
	
	@Override
	public String behaviour() {
		
		return  "Behaviour : All the alkaline earth metals readily lose their two outermost "
