...
public class NobleGas extends Element {
	...
	public NobleGas (double atomicWeight, double meltingPoint, double boilingPoint, double density) {
		super();
	...
	//Constructor  with all properties
		public NobleGas (int atomicNumber, String name, String symbol, String electron, String origin, int group,
	...
	public String properties() {
		...
		return "Properties : As all noble gases conduct electricity, fluoresce, are odorless and colorless. ";
	}
	
	@Override
	public String behaviour() {
		
		return  "Behaviour :  Low chameical reactivity. ";
	}
